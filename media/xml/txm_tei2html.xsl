...
<xsl:stylesheet xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:txm="http://textometrie.org/1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
...
<xsl:template match="tei:w">
	<xsl:element name="span">
		...
		<xsl:attribute name="title">
				<xsl:value-of select="tei:interp[@type='#ttpos']"/>_<xsl:value-of select="tei:interp[@type='#ttlemma']"/>
		</xsl:attribute>
		<xsl:attribute name="pos">
			<xsl:value-of select="tei:interp[@type='#ttpos']"/>
		</xsl:attribute>
		<xsl:attribute name="lem">
			<xsl:value-of select="tei:interp[@type='#ttlemma']"/>
		</xsl:attribute>
	...
	<html xmlns="http://www.w3.org/1999/xhtml">
  	...
  	<body>
		<div class="meta">
  		...
  		<h2>Speakers</h2>
  		<ul>
			<xsl:for-each select="tei:TEI/tei:Speakers">
		...
		<div class="verbatim">
  		<h1>Transcription</h1>
  		<xsl:for-each select="tei:TEI/tei:textunit">
			<div class="speaker-part">
				<div class="speaker-name">
					<h3>spk_<xsl:value-of select="@speaker"/>: </h3>
				</div>
